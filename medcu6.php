...
{
    if (array_key_exists("Mediterranean_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Mediterranean_Cuisine_Course']+1;
        setcookie('services[Mediterranean_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Mediterranean_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/medcu6.css?crc=134957987"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2024">
        <!-- image -->
        <img
          class="block"
          id="u2024_img"
          src="images/medcu6-crop-u2024.jpg?crc=471398589"
          alt=""
          data-heightwidthratio="0.9497098646034816"
          data-image-width="517"
          data-image-height="491"
        />
      </div>
      <div class="clearfix grpelem" id="pu2026-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2026-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Mediterranean
            Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2028-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
      ...
      <div
        ...
        data-offset-top="491"
        data-content-above-spacer="491"
        data-content-below-spacer="9"
