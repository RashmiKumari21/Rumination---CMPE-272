...
{
    if (array_key_exists("Indian_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Indian_Cuisine_Course']+1;
        setcookie('services[Indian_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Indian_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/indcu6.css?crc=207425457"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u1986">
        <!-- image -->
        <img
          class="block"
          id="u1986_img"
          src="images/indcu6-crop-u1986.jpg?crc=3979203073"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu1988-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u1988-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Indian Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u1990-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
