...
{
    if (array_key_exists("Singing_2_months_course_(Basic)",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Singing_2_months_course_(Basic)']+1;
        setcookie('services[Singing_2_months_course_(Basic)]',$newValue);
    }
    else
    {
        setcookie('services[Singing_2_months_course_(Basic)]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/sing2.css?crc=3851354493"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2324">
        <!-- image -->
        <img
          class="block"
          id="u2324_img"
          src="images/sing2-crop-u1829.jpg?crc=3921155383"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2326-17">
        <!-- group -->
        <div class="clearfix grpelem" id="u2326-17">
          <!-- content -->
          <p>
            In this course you will be learning how to sing songs at a very
            basic level.
          </p>
          <p>&nbsp;</p>
          <p>
            This course is good for people who want to learn to sing their
            favorite songs or when they want to sing for a special event,
            occasion, a loved one.
          </p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>
            You should be able to sing a collection of song with confidence by
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2328-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
      ...
      <div
        ...
        data-offset-top="485"
        data-content-above-spacer="485"
        data-content-below-spacer="15"
