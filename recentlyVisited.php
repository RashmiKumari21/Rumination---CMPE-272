...
<html><title>Top Visited Services</title><head>
<a style="float:right; color:white; margin-top:25p" href="services.php">Go back to Services</a>

<h1 style="margin-right: 14px; margin-top:10px;">Recently Viewed Services</h1>
</head>
<style>
a {
...
if (!isset($_COOKIE['services']))
{
    ...
    $recent=array_reverse($servicesData);
    foreach(array_slice($recent,0,5) as $key=> $value){
        
        print("<tr><td>".str_replace('_',' ',$key)."</td></tr>");
    }
    echo "</table>";
}
