...
{
    if (array_key_exists("Icecream_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Icecream_Course']+1;
        setcookie('services[Icecream_Course]',$newValue);
    }
    else
    {
        setcookie('services[Icecream_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/ice6.css?crc=263579004"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2277">
        <!-- image -->
        <img
          class="block"
          id="u2277_img"
          src="images/icecu6-crop-u2277.jpg?crc=319526594"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2279-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2279-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make ice creams with
            Love.
          </p>
          <p>&nbsp;</p>
          <p>
            We will cover major and famous ice creams around the world. You will
            learn techniques to make ice creams and understand the things to
            keep in mind. Learn about this the right way and play with what you
            learned.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2281-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
