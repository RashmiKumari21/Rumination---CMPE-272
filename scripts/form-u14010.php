...
$form = array(
	'subject' => 'RESERVATION Desktop Form Submission',
	...
	'fields' => array(
		...
		'custom_U14031' => array(
			...
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Special Occasion\' is required.'
			)
		),
		'custom_U14021' => array(
			'order' => 4,
			'type' => 'string',
			'label' => 'Interested in Learning which Activity',
			'required' => true,
			'errors' => array(
				'required' => 'Field \'Interested in Learning which Activity\' is required.'
			)
		)
	)
);
