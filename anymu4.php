...
{
    if (array_key_exists("Any_Musical_Instrument_4_months_course_(Medium)",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Any_Musical_Instrument_4_months_course_(Medium)']+1;
        setcookie('services[Any_Musical_Instrument_4_months_course_(Medium)]',$newValue);
    }
    else
    {
        setcookie('services[Any_Musical_Instrument_4_months_course_(Medium)]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/anymu4.css?crc=4000981846"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u1929">
        <!-- image -->
        <img
          class="block"
          id="u1929_img"
          src="images/anymu4-crop-u1929.jpg?crc=3831562475"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu1931-16">
        <!-- group -->
        <div class="clearfix grpelem" id="u1931-16">
          <!-- content -->
          <p>
          ...
          <p>&nbsp;</p>
          <p>
            You should be able learn how to approach learning a tune on the
            musical instrument. Understanding on Tunes and which tunes will be
            easy and which ones will not.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u1933-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
      ...
      <div
        ...
        data-offset-top="488"
        data-content-above-spacer="488"
        data-content-below-spacer="12"
