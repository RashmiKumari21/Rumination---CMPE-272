...
{
    if (array_key_exists("Ethiopian_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Ethiopian_Cuisine_Course']+1;
        setcookie('services[Ethiopian_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Ethiopian_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/ethcu6.css?crc=271241622"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2046">
        <!-- image -->
        <img
          class="block"
          id="u2046_img"
          src="images/ethcu6-crop-u2046.jpg?crc=214483452"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2048-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2048-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Ethiopian
            Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2050-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
