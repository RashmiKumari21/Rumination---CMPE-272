...
{
    if (array_key_exists("North_American_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['North_American_Cuisine_Course']+1;
        setcookie('services[North_American_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[North_American_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/norcu6.css?crc=113828635"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2128">
        <!-- image -->
        <img
          class="block"
          id="u2128_img"
          src="images/norcu6-crop-u2128.jpg?crc=136424991"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2130-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2130-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make North American
            Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2132-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
