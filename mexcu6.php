<?php
(isset($_COOKIE['services']) and array_key_exists("Mexican_Cuisine_Course",$_COOKIE['services'])) ? setcookie('services[Mexican_Cuisine_Course]',$_COOKIE['services']['Mexican_Cuisine_Course']+1): setcookie('services[Mexican_Cuisine_Course]',1);
?>
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/mexcu6.css?crc=3787784693"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      ...
      <div class="clip_frame grpelem" id="u2090">
        ...
        <img
          class="block"
          id="u2090_img"
          src="images/mexcu6-crop-u2090.jpg?crc=13232244"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2092-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2092-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Mexican Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2094-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
