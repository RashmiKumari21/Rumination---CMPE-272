...
{
    if (array_key_exists("French_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['French_Cuisine_Course']+1;
        setcookie('services[French_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[French_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/frecu6.css?crc=191393208"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2223">
        <!-- image -->
        <img
          class="block"
          id="u2223_img"
          src="images/frecu6-crop-u2223.jpg?crc=281172785"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2225-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2225-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make French Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2227-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
