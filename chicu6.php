...
{
    if (array_key_exists("Chinese_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Chinese_Cuisine_Course']+1;
        setcookie('services[Chinese_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Chinese_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/chicu6.css?crc=3783050933"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2166">
        <!-- image -->
        <img
          class="block"
          id="u2166_img"
          src="images/chicu6-crop-u2166.jpg?crc=4212628596"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2168-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2168-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Chinese Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2170-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
