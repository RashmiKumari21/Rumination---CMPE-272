...
{
    if (array_key_exists("Italian_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Italian_Cuisine_Course']+1;
        setcookie('services[Italian_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Italian_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/itacu6.css?crc=3791259299"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2071">
        <!-- image -->
        <img
          class="block"
          id="u2071_img"
          src="images/itacu6-crop-u2071.jpg?crc=397766421"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2073-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2073-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Italian Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
