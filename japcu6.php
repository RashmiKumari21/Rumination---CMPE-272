...
{
    if (array_key_exists("Japanese_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Japanese_Cuisine_Course']+1;
        setcookie('services[Japanese_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Japanese_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/japcu6.css?crc=4028629730"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2185">
        <!-- image -->
        <img
          class="block"
          id="u2185_img"
          src="images/japcu6-crop-u2185.jpg?crc=4245846287"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2187-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2187-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Japanese
            Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2189-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
