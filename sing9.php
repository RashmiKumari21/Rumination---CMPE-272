...
{
    if (array_key_exists("Singing_9_months_course_(Advanced)",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Singing_9_months_course_(Advanced)']+1;
        setcookie('services[Singing_9_months_course_(Advanced)]',$newValue);
    }
    else
    {
        setcookie('services[Singing_9_months_course_(Advanced)]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/sing9.css?crc=71396494"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u1882">
        <!-- image -->
        <img
          class="block"
          id="u1882_img"
          src="images/sing9-crop-u1882.jpg?crc=3824030975"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu1884-16">
        <!-- group -->
        <div class="clearfix grpelem" id="u1884-16">
          <!-- content -->
          ...
          <p>
            ...
            as a passion and will continue pursuing it.
          </p>
          <p>&nbsp;</p>
          <p>
            ...
            will not. You will be able to make unplugged versions of songs. This
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u1886-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
