...
{
    if (array_key_exists("Canadian_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Canadian_Cuisine_Course']+1;
        setcookie('services[Canadian_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Canadian_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/cacu6.css?crc=4291249416"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2005">
        <!-- image -->
        <img
          class="block"
          id="u2005_img"
          src="images/cacu6-crop-u2005.jpg?crc=4114081685"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2007-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2007-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Canadian
            Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2009-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
      ...
      <div
        ...
        data-offset-top="495"
        data-content-above-spacer="495"
        data-content-below-spacer="4"
