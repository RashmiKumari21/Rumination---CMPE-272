...
{
    if (array_key_exists("Australian_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Australian_Cuisine_Course']+1;
        setcookie('services[Australian_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[Australian_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/auscu6.css?crc=3873875460"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2109">
        <!-- image -->
        <img
          class="block"
          id="u2109_img"
          src="images/auscu6-crop-u2109.jpg?crc=94362712"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2111-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2111-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make Australian
            Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2113-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
