...
{
    if (array_key_exists("South_American_Cuisine_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['South_American_Cuisine_Course']+1;
        setcookie('services[South_American_Cuisine_Course]',$newValue);
    }
    else
    {
        setcookie('services[South_American_Cuisine_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/soucu6.css?crc=4016536427"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      ...
      <div class="clip_frame grpelem" id="u2147">
        ...
        <img
          class="block"
          id="u2147_img"
          src="images/soucu6-crop-u2147.jpg?crc=3990589845"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2149-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2149-13">
          <!-- content -->
          <p>
            In this course you will be learning how how to make South American
            Cuisine.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2151-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
