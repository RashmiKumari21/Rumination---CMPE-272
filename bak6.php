...
{
    if (array_key_exists("Baking_Course",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Baking_Course']+1;
        setcookie('services[Baking_Course]',$newValue);
    }
    else
    {
        setcookie('services[Baking_Course]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/bak6.css?crc=3804683708"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u2242">
        <!-- image -->
        <img
          class="block"
          id="u2242_img"
          src="images/bakcu6-crop-u2242.jpg?crc=4083940234"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu2244-13">
        <!-- group -->
        <div class="clearfix grpelem" id="u2244-13">
          <!-- content -->
          <p>In this course you will be learning how how to Bake with Love.</p>
          <p>&nbsp;</p>
          <p>
            We will cover major and famous baked delicacies around the world.
            You will learn techniques to bake and understand the things to keep
            in mind. Learn about baking the right way and play with what you
            learned.
          </p>
          <p>&nbsp;</p>
          <p>
        ...
        <a href="contact.php" style="display: block">
          <!-- container box -->
          <div class="clearfix grpelem" id="u2246-4">
            <!-- content -->
            <p>Interested</p>
          </div>
        </div>
