...
{
    if (array_key_exists("Any_Musical_Instrument_2_months_course_(Basic)",$_COOKIE['services']))
    {
        $data=$_COOKIE['services'];
        $newValue=$data['Any_Musical_Instrument_2_months_course_(Basic)']+1;
        setcookie('services[Any_Musical_Instrument_2_months_course_(Basic)]',$newValue);
    }
    else
    {
        setcookie('services[Any_Musical_Instrument_2_months_course_(Basic)]',1);
    }
...
<html class="nojs html css_verticalspacer" lang="en-US">
  <head>
    ...
    <link
      rel="stylesheet"
      type="text/css"
      href="css/anymu2.css?crc=4169740395"
      id="pagesheet"
    />
  </head>
  <body>
    <div class="clearfix borderbox" id="page">
      <!-- group -->
      <div class="clip_frame grpelem" id="u1901">
        <!-- image -->
        <img
          class="block"
          id="u1901_img"
          src="images/anymu2-crop-u1901.jpg?crc=189075704"
          alt=""
      ...
      <div class="clearfix grpelem" id="pu1903-17">
        <!-- group -->
        <div class="clearfix grpelem" id="u1903-17">
          <!-- content -->
          <p>
            In this course you will be learning how to play songs at a very
            basic level on a musical instrument.
          </p>
          <p>&nbsp;</p>
          <p>
            This course is good for people who want to learn to perform their
            favorite songs or when they want to perform for a special event,
            occasion, a loved one.
          </p>
          <p>&nbsp;</p>
          <p>&nbsp;</p>
          <p>
            You should be able to perform a collection of song with confidence
